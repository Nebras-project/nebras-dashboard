const ar = {
  ...
  users: {
    ...
    curriculumManager: 'مدير المراحل الدراسية و المناهج',
  ...
  curriculum: {
    ...
    noCurriculums: 'لا توجد مراحل دراسية',
    noCurriculumsDescription: 'ابدأ بإنشاء مرحلة دراسية جديدة لإدارة المواد والوحدات والدروس',
    ...
    pageDescription: 'إدارة المراحل الدراسية وإنشاء وتنظيم المواد والوحدات والدروس',
    curriculumDetails: 'تفاصيل المرحلة الدراسية',
    curriculumNotFound: 'المرحلة الدراسية غير موجودة',
    curriculumNotFoundDescription: 'المرحلة الدراسية المطلوبة غير موجودة أو تم حذفها',
    deleteConfirmTitle: 'حذف المرحلة الدراسية',
  ...
  curriculums: {
    entityName: 'مرحلة دراسية',
    deleteConfirmTitle: 'حذف المرحلة الدراسية',
    deleteConfirmMessage: 'هل أنت متأكد من حذف {{name}}؟ لا يمكن التراجع عن هذا الإجراء.',
    deleteErrorTitle: 'فشل الحذف',
    deleteErrorMessage: 'فشل حذف المرحلة الدراسية {{name}}. يرجى المحاولة مرة أخرى.',
  },
  ...
  managers: {
    ...
    roles: {
      'Curriculum Manager': 'مدير المراحل الدراسية و المناهج',
