const ar = {
  ...
  questions: {
    ...
    batchCreateSuccessMessage: 'تم إنشاء {{count}} سؤال بنجاح.',
    batchCreateErrorMessage: 'فشل في إنشاء الأسئلة. يرجى المحاولة مرة أخرى.',
    batchCreatePartialSuccessMessage:
      'تم إنشاء {{successCount}} من {{totalCount}} أسئلة بنجاح. الخطأ: {{error}}',
    uploadImage: 'رفع صورة',
    imageUploadSuccessMessage: 'تم رفع الصورة بنجاح.',
    imageUploadErrorMessage: 'فشل في رفع الصورة. يرجى المحاولة مرة أخرى.',
