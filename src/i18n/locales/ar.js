const ar = {
  ...
  users: {
    ...
    curriculumManager: 'مدير المراحل الدراسية',
  ...
  managers: {
    ...
    roles: {
      'Curriculum Manager': 'مدير المراحل الدراسية',
  ...
  admins: {
    ...
    description:
      'متابعة المسؤول الإداري  والمالك، وضبط الصلاحيات العليا وتوحيد المسؤوليات القيادية عبر المنصة.',
    roles: {
      Owner: 'المالك',
