const en = {
  ...
  common: {
    ...
    filterDisabledTooltip: 'No data available to filter',
    export: 'Export',
    exportDisabledTooltip: 'No data available to export',
    import: 'Import',
    loading: 'Loading...',
  ...
  grade: {
    ...
    noGradesDescription: 'Start by creating a new grade to manage subjects, units, and lessons',
    noSubjects: 'No subjects found',
    noSubjectsDescription: 'Start by adding a new subject to this grade',
    noUnits: 'No units found',
    noLessons: 'No lessons found',
    pageDescription: 'Manage educational grades and organize subjects, units, and lessons',
    gradeDetails: 'Grade Details',
    gradeNotFound: 'Grade Not Found',
    gradeNotFoundDescription: 'The requested grade does not exist or has been deleted',
    deleteConfirmTitle: 'Delete Grade',
  ...
  questions: {
    ...
    batchCreateSuccessMessage: '{{count}} question(s) created successfully.',
    batchCreateErrorMessage: 'Failed to create questions. Please try again.',
    batchCreatePartialSuccessMessage:
      '{{successCount}} of {{totalCount}} questions created successfully. Error: {{error}}',
    uploadImage: 'Upload Image',
    imageUploadSuccessMessage: 'Image uploaded successfully.',
    imageUploadErrorMessage: 'Failed to upload image. Please try again.',
  ...
  managers: {
    ...
    actionsTooltip: 'Manager Actions',
    role: 'Role',
    ...
    createErrorTitle: 'Create Failed',
    createErrorMessage: 'Failed to create manager. Please try again.',
    updateSuccessTitle: 'Manager Updated',
    updateSuccessMessage: 'Manager {{name}} has been updated successfully',
    updateErrorTitle: 'Update Failed',
    updateErrorMessage: 'Failed to update manager. Please try again.',
    // Delete messages
    deleteConfirmTitle: 'Delete Manager',
    deleteConfirmMessage: 'Are you sure you want to delete {{name}}? This action cannot be undone.',
    deleteSuccessTitle: 'Manager Deleted',
    deleteSuccessMessage: 'Manager {{name}} has been deleted successfully',
    deleteErrorTitle: 'Delete Failed',
    deleteErrorMessage: 'Failed to delete manager {{name}}. Please try again.',
    filter: {
  ...
  admins: {
    ...
    actionsTooltip: 'Admin Actions',
    role: 'Role',
    assignRole: 'Assign Role',
    generalAdmins: 'General Admins',
    managers: 'Managers',
    description:
      'Oversee general administrators, controlling top-level access and aligning leadership responsibilities across the platform.',
    roles: {
      Owner: 'Owner',
