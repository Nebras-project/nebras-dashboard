...
/**
 * CompetitionFilterActions Component
 *
 * Single Responsibility: Competition-specific filter actions (toggle filters, clear, and add button)
 */
const CompetitionFilterActions = memo(function CompetitionFilterActions({
  showFilters,
  onToggleFilters,
  hasActiveFilters,
  onClearFilters,
...
CompetitionFilterActions.propTypes = {
...
export default CompetitionFilterActions;
